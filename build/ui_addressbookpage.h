...
public:
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        QBrush brush1(QColor(182, 184, 79, 0));
        ...
        QBrush brush2(QColor(255, 252, 203, 255));
        ...
        labelExplanation->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);"));
        ...
        QBrush brush5(QColor(182, 184, 79, 255));
        ...
        signMessage->setPalette(palette1);
        QIcon icon3;
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
        ...
        labelExplanation->setText(QApplication::translate("AddressBookPage", "These are your bitFlowers addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you.", 0, QApplication::UnicodeUTF8));
...
#ifndef QT_NO_TOOLTIP
        signMessage->setToolTip(QApplication::translate("AddressBookPage", "Sign a message to prove you own a bitFlowers address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        signMessage->setText(QApplication::translate("AddressBookPage", "Sign &Message", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        verifyMessage->setToolTip(QApplication::translate("AddressBookPage", "Verify a message to ensure it was signed with a specified bitFlowers address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
